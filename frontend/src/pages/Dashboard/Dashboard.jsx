  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const inventoryResponse = await axios.get('https://supply-chain-iq.vercel.app/api/inventory');
        setInventoryData(inventoryResponse.data);

        // Fetch orders data from API
        const ordersResponse = await axios.get('https://supply-chain-iq.vercel.app/api/orders');
